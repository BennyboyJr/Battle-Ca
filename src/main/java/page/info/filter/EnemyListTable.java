...
public class EnemyListTable extends SortTable<Enemy> {
	...
	public static void redefine() {
		tit = new String[] { "ID", "name", Page.get(MainLocale.INFO, "HP"), Page.get(MainLocale.INFO, "hb"), Page.get(MainLocale.INFO, "Damage"), Page.get(MainLocale.INFO, "range"), Page.get(MainLocale.INFO, "atkf"),
